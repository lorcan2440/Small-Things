...
ANIM_STEP_T = 0.5                     # update frame every interval
...
if __name__ == '__main__':
    ...
    ax_img.imshow(plt.imread(r'C:\Users\lnick\Documents\Personal\Programming\Python\Simulations\cstr_pic.png'))
    ax_img.set_axis_off()
    ...
    ani = anim.FuncAnimation(fig, animate, fargs=(history,), init_func=init_graph, \
                             interval=10, save_count=1e6)
    plt.show()

    #print('Making video...')
    #ani.save('MyVideo.mp4', writer=vid_writer)
    print('Finished!')
