...
STYLESHEET = r'C:\Users\lnick\Documents\Personal\Programming\Python\Resources\proplot_style_dark.mplstyle'  # dark has enlarged screen (don't know why! doesn't happen in other programs)
